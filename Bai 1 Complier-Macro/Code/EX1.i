...
# 9 "EX1.c"
void sv1() { printf("Trinh, "); printf(" sdt:09xxx\n"); };
void sv2() { printf("Duc, "); printf("08xxx\n"); };
void sv3() { printf("Nam, "); printf("06xxx\n"); };
# 34 "EX1.c"
int main()
{
    sv1();
    ...
    printf("value %d\n", ab);
    printf("hello world");
    int arr[] = {1,2,3,4,6,9, 0}; int sum = 0; int i =0; while(arr[i] != 0) { sum += arr[i]; i++; } printf("\n tong la %d\n", sum);;
